<x-app-layout>
    ...
    <div class="py-6 bg-white">
        <form action="{{ route('reservorio.store') }}" method="POST" class="max-w-md mx-autox">
            @csrf
            ...
            <div class="mb-5">
                ...
                <input type="text" name="reservorio" id="reservorio" value="{{ old('reservorio') }}"
            ...
            <div class="mt-6 flex gap-4">
                ...
                <button type="button"
                    onclick="window.location='{{ route('reservorio.index', ['ciudad_id' => request('ciudad_id')]) }}'""
