<x-app-layout>
    ...
    <div class="py-6 bg-white">
        <form action="{{ route('manzana.update', $manzana) }}" method="POST" class="max-w-md mx-autox">
            @csrf
            @method('PUT')
            ...
            <div class="mb-5">
                ...
                <input type="text" name="manzana" id="manzana" value="{{ old('manzana', $manzana->manzana) }}"
            ...
            <div class="mt-6 flex gap-4">
                ...
                <button type="button"
                    onclick="window.location='{{ route('manzana.index', ['sector_id' => $sector->id]) }}'"
