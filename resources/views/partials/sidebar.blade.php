                            ...
                            <div class="simplebar-content" style="padding: 0px 56px 12px 28px;">
                                <ul class="scrollable">
                                    @foreach ($menu as $item)
                                        ...
                                        @else
                                            <li>
                                                <a href="{{ $item['url'] ?? 'javascript:;' }}" class="side-menu__link {{ $item['active'] ?? false ? 'side-menu__link--active' : '' }}">
                                                    @if (isset($item['icon']))
                                                    ...
                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-lucide="chevron-down" class="lucide lucide-chevron-down size-4 stroke-[1.5] [--color:currentColor] stroke-(--color) fill-(--color)/25 side-menu__link__chevron transition">
                                                ...
                                                @if (!empty($item['children']))
                                                    <ul class="{{ $item['active'] ?? false ? 'block' : 'hidden' }}">
                                                        @foreach ($item['children'] as $child)
                                                            <li>
                                                                <a href="{{ $child['url'] }}" class="side-menu__link {{ $child['active'] ?? false ? 'side-menu__link--active' : '' }}">
                                                                    @if (isset($child['icon']))
                                                                ...
                                                                @endif
                                                                    <div class="side-menu__link__title">{{ $child['title'] }}</div>
                                                                </a>
                                                            </li>
                                                        @endforeach
                                                    </ul>
