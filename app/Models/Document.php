...
{
    protected $with = ['user', 'soap_type', 'state_type', 'document_type', 'currency_type', 'group', 'items', 'invoice', 'payments'];
    ...
    public function getCuotasAttribute($value)
    {
        return (is_null($value)) ? null : (object)json_decode($value);
    }

    public function setCuotasAttribute($value)
    {
        $this->attributes['cuotas'] = (is_null($value)) ? null : json_encode($value);
    }
    ...
    public function external_seller()
    {
        return $this->belongsTo(ExternalSeller::class);
    }
    ...
    public function establishment2()
    {
    ...
    public function online_document()
    {
        return $this->hasOne(DocumentSentOnline::class);
    }
    ...
    public function getNumberFullAttributeFormat()
    {
        return $this->series . '-' . sprintf("%06s", $this->number);
    }
